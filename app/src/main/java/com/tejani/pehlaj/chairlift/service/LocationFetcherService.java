package com.tejani.pehlaj.chairlift.service;
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (! SmartLocationManager.checkPermission(this)) {
                        ...
                        smartLocationManager = new SmartLocationManager (this, SmartLocationManager.FETCH_LOCATION_BETWEEN_INTERVAL, this, SmartLocationManager.ALL_PROVIDERS, 2 * 1000, 1 * 1000, SmartLocationManager.LOCATION_PROVIDER_GPS_ONLY_RESTRICTION, SmartLocationManager.ANY_API); // init location manager
                    }
                } else {
                    smartLocationManager = new SmartLocationManager (this, SmartLocationManager.FETCH_LOCATION_BETWEEN_INTERVAL, this, SmartLocationManager.ALL_PROVIDERS, 2 * 1000, 1 * 1000, SmartLocationManager.LOCATION_PROVIDER_GPS_ONLY_RESTRICTION, SmartLocationManager.ANY_API); // init location manager
                }
